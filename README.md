...
### Business Impact
In high-stakes environments like Banking, data integrity is paramount. This project showcases my ability to use SQL to audit, clean, and structure 'noisy' global datasets. It reflects the same methodical rigor I applied in my Biochemistry research to ensure that executive reports are based on 100% accurate information
